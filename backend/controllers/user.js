...
module.exports.register = async (req,res)=>{
        ...
        if(role == 'Editor'){
            ...
            newUser = new User({name,email,username,role,bio,mobile,specialization});
        }else if(role == 'Participants'){
            const {type,qualification,designation,affiliation} = req.body;
            newUser = new User({name,email,username,role,bio,mobile,type,qualification,designation,affiliation});
        }
