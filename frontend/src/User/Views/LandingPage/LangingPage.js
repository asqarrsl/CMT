    ...
    return(
        <>
            ...
            <div className="container-fluid p-0">
                ...
                <div className="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('img/bg-showcase-1.jpg');"></div>
                ...
                <div className="row no-gutters">
                <div className="col-lg-6 text-white showcase-img" style="background-image: url('img/bg-showcase-2.jpg');"></div>
                ...
                <div className="row no-gutters">
                <div className="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('img/bg-showcase-3.jpg');"></div>
                <div className="col-lg-6 order-lg-1 my-auto showcase-text">
